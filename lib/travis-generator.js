...
TravisGenerator.prototype.travisGitHubAuthentication = function () {
    ...
    return authRequest.promise.then(function (res) {
        try {
            ...
            this.get('travis').authenticate(this.get('travisAccessToken'), authorizeRequest.makeNodeResolver());
            authorizeRequest.promise.then(function (res) {
                console.log('res', res);
            }, function (err) {
                console.log('err', err);
            });
...
TravisGenerator.prototype.setTravisHook = function (hook) {
    console.log('setTravisHook', hook);
    ...
    setHookRequest.promise.then(function (res) {
        console.log('setHookRequest', res);
    });
